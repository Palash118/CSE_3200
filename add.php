...
<h1 class="text-center mt-5 pt-4 pb-3"> User List </h1>
...
<tbody>
    ...
    <td>
    <form method="POST" >
        <button class="btn btn_up btn-sm me-4" type="submit" name="add1">Add</button>
        <button class="btn btn_up btn-sm" type="submit" name="remove1">Remove</button>
        </form>
